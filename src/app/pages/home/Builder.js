...
export default function Builder() {
  ...
  const { layoutConfig } = useSelector(({ builder }) => ({ layoutConfig: builder.layoutConfig }), shallowEqual);
  ...
  return (
    <>
      <Notice icon="flaticon-warning kt-font-primary">
        The layout builder helps to configure the layout with preferred options and preview it in real time. The
        configured layout options will be saved until you change or reset them. To use the layout builder choose the
        layout options and click the <code>Preview</code> button to preview the changes.
      </Notice>
        ...
        {({ values, handleReset, handleSubmit, handleChange, handleBlur }) => (
          <div className="kt-form kt-form--label-right">
                  ...
                  <div className="kt-section kt-margin-t-30">
                    <div className="kt-section__body">
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Header Skin:</label>
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Header Menu Skin:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                            className="form-control"
                            name="header.menu.desktop.submenu.skin"
                            onBlur={handleBlur}
                            value={get(values, 'header.menu.desktop.submenu.skin')}
                            onChange={handleChange}
                          >
                            <option value="light">Light (Default)</option>
                            <option value="dark">Dark</option>
                          </select>
                          <FormHelperText>Select header menu skin</FormHelperText>
                        </div>
                      </div>
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Logo Bar Skin:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                            className="form-control"
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Aside Skin:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                            className="form-control"
              ...
              {tab === 1 && (
                <PortletBody>
                  <div className="kt-section kt-margin-t-30">
                    <div className="kt-section__body">
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Fixed Desktop Header:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Mobile Fixed Header:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Display Header Menu:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Header Menu Layout:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                            className="form-control"
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Header Menu Arrows:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
              ...
              {tab === 2 && (
                <PortletBody>
                  <div className="kt-section kt-margin-t-30">
                    <div className="kt-section__body">
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Display Subheader:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                          ...
                          />
                          <FormHelperText>Enable/Disable subheader</FormHelperText>
                        </div>
                      </div>

                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Fixed Subheader:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Subheader Style:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                            className="form-control"
              ...
              {tab === 4 && (
                <PortletBody>
                  <div className="kt-section kt-margin-t-30">
                    <div className="kt-section__body">
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Display:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Fixed:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Minimize:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Default Minimize:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label pt-4">Submenu Toggle:</label>
                        <div className="col-lg-9 col-xl-4">
                          {' '}
                          <select
                            className="form-control"
                            ...
                            onBlur={handleBlur}
                            value={get(values, 'aside.menu.dropdown').toString()}
                            onChange={handleChange}
                          >
              ...
              {tab === 5 && (
                <PortletBody>
                  <div className="kt-section kt-margin-t-30">
                    <div className="kt-section__body">
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label">Fixed Footer:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
            ...
            <Portlet>
              <PortletHeader
                title={
                  <>
                    Generated Config{' '}
                    <small>
                      can be used for layout config in <code>/src/_metronic/layouts/demo1/LayoutConfig.js</code>
                    </small>
                  </>
                }
              />
              ...
              <PortletBody>
                <CodeBlock disableCopy="true" language="json" code={JSON.stringify(values, null, 2)} />
              </PortletBody>
            </Portlet>
          </div>
        )}
